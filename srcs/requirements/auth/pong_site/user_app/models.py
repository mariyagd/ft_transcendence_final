...
class User(AbstractUser):
    ...
    # represented as 32 base-16 characters, that can be used to identify information across a
    # computer system. using UUID for your project can make your site more professional and reliable
    # because of that for the most part ID of your resources are not humanly guessable also its unique
    # from any other resource’s ID in the internet.
